...
export default function CommercialPage() {
  return (
    <>
      {/* Hero */}
      <section className="relative pt-32 pb-20 bg-cover bg-center bg-scroll md:bg-fixed" style={{ backgroundImage: "url('/images/service-commercial.jpg')" }}>
      ...
      {/* CTA */}
      <section className="relative py-28 bg-cover bg-center bg-scroll md:bg-fixed" style={{ backgroundImage: "url('/images/service-commercial.jpg')" }}>
        ...
        <div className="relative z-10 max-w-3xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          ...
          <h2 className="font-heading text-4xl sm:text-5xl lg:text-6xl font-bold text-white mb-5 leading-tight">
            Let&apos;s Elevate
            <br />
            <span className="italic text-brand-gold">Your Business</span>
          </h2>
          <p className="text-white/70 mb-10 max-w-xl mx-auto">
            We offer free on-site consultations for commercial properties. No obligation — just expert advice.
          </p>
