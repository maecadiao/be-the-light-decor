    ...
    <>
      ...
      <section className="relative pt-32 pb-20 overflow-hidden">
        <Image
          ...
          alt="Professional event and wedding lighting by Be The Light Decor in Southeast Louisiana"
          fill
        ...
        <div className="relative z-10 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 items-start">
            ...
            <div className="aspect-[4/3] rounded-2xl overflow-hidden shadow-2xl relative">
              <Image
                src="/images/service-event.jpg"
                alt="Event lighting setup by Be The Light Decor"
                fill
                className="object-cover"
              />
            </div>
      ...
      <section className="relative py-28 overflow-hidden">
        <Image src="/images/service-event.jpg" alt="" fill className="object-cover" />
